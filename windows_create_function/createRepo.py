...
def main():
    ...
    if system == 'win32':
        projects_path = 'C:/Users/Samuel/Desktop/Projects'
    elif system == 'linux':
        projects_path = '/home/sam/Desktop/Projects'
    elif system == 'darwin':
        projects_path = '/home/Users/Samuel/Desktop/Projects'
    else:
        print("[ERROR]: Tu sistema no fue identificado como compatible.")
        return None
